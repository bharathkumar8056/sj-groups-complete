...
const products = {
  "bamboo-salt-3x": {
    name: "Bamboo Salt 3x Roasted",
    category: "bamboo-salt",
    image: "/assets/products/bamboo-salt-3x.jpeg",
    price: "Contact for quote",
    roastLevel: "3x",
    description: "Premium 3x roasted bamboo salt - perfect balance of purity and mineral richness",
    extraction:
      "Three roasting cycles create our foundational 3x bamboo salt. This carefully controlled process removes impurities while preserving essential minerals, resulting in a versatile product suitable for both culinary and therapeutic applications. The salt is roasted at temperatures between 900°C-1500°C in bamboo trunks sealed with natural red clay.",
    benefits: [
      "Balanced mineral profile with 70-80 essential minerals",
      "Alkaline properties (pH 9-10) for body pH balance",
      "Natural antioxidant properties",
      "Suitable for daily culinary and wellness use",
      "Cost-effective entry to bamboo salt benefits",
      "Removes harmful impurities and heavy metals",
    ],
    specifications: {
      roastLevel: "3x",
      color: "Light gray to white",
      texture: "Fine to medium granules",
  ...
  "bamboo-salt-6x": {
    ...
    category: "bamboo-salt",
    image: "/assets/products/bamboo-salt-6x.jpeg",
    price: "Contact for quote",
    roastLevel: "6x",
  ...
  "bamboo-salt-7x": {
    ...
    category: "bamboo-salt",
    image: "/assets/products/bamboo-salt-7x.jpeg",
    price: "Contact for quote",
    roastLevel: "7x",
  ...
  "bamboo-salt-8x": {
    ...
    category: "bamboo-salt",
    image: "/assets/products/sj-home.jpeg",
    price: "Contact for quote",
    roastLevel: "8x",
  ...
  "bamboo-salt-9x": {
    ...
    category: "bamboo-salt",
    image: "/assets/products/bamboo-salt-9x.jpeg",
    price: "Contact for quote",
    roastLevel: "9x",
