  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href="/assets/Sj-logo-final.jpg" />
        <link rel="icon" type="image/png" sizes="32x32" href="/assets/Sj-logo-final.jpg" />
        <link rel="apple-touch-icon" href="/assets/Sj-logo-final.jpg" />
      </head>
